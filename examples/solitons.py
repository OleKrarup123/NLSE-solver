...
def simulate_solitons():
    ...
    input_signal_order_2= InputSignal(time_freq,
    ...
    input_signal_order_4= InputSignal(time_freq,
    ...
    plot_everything_about_result(ssfm_result_list_order_2_no_NL,
    ...
    plot_everything_about_result(ssfm_result_list_order_2,
                                    nrange_pulse=nrange_pulse,
                                    dB_cutoff_pulse=dB_cutoff_pulse,
                                    nrange_spectrum=nrange_spectrum,
                                    dB_cutoff_spectrum=dB_cutoff_spectrum)
    ...
    plot_everything_about_result(ssfm_result_list_order_4,
                                    nrange_pulse=nrange_pulse,
                                    dB_cutoff_pulse=dB_cutoff_pulse,
                                    nrange_spectrum=nrange_spectrum,
                                    dB_cutoff_spectrum=dB_cutoff_spectrum)
